...
Route::get('nilai/{id_mahasiswa}', 'NilaiController@detailNilaiMahasiswa')->name('detail.nilaimahasiswa');
Route::get('nilai/{id_mahasiswa}/edit', 'NilaiController@editNilaiMahasiswa')->name('edit.nilaimahasiswa');
